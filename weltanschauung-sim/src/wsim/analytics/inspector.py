        ...
        rounds.append(
            {
                ...
                "world_history_power_calculations": _payloads(round_events, {"world_history_power_calculated"}),
                "combat_details": _payloads(round_events, {"combat_resolved"}),
    ...
    for round_info in rounds:
        lines.extend(
            [
                ...
                f"- Deutungshoheit / Machtberechnung: {json.dumps(round_info.get('world_history_power_calculations', []), ensure_ascii=True, sort_keys=True)}",
                ...
                f"- Kampfdetails / Zielmarker / Ersatzeffekte: {json.dumps(round_info.get('combat_details', []), ensure_ascii=True, sort_keys=True)}",
