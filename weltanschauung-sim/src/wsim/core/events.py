...
class EventType(StrEnum):
    ...
    NOT_ENOUGH_CARDS_TO_DRAW = "not_enough_cards_to_draw"
    CARD_DRAWN = "card_drawn"
    CARD_DRAFTED = "card_drafted"
    CARD_DISCARDED = "card_discarded"
    CARD_REMOVED_FROM_GAME = "card_removed_from_game"
    PROPAGANDA_PLACED = "propaganda_placed"
    PROPAGANDA_REMOVED = "propaganda_removed"
    PROPAGANDA_COMBO_DETECTED = "propaganda_combo_detected"
    JOURNALIST_ACTION_TAKEN = "journalist_action_taken"
    MEDIA_MOGUL_ACTION_TAKEN = "media_mogul_action_taken"
    ROUND_START_SNAPSHOT = "round_start_snapshot"
    JOURNALIST_CHECKED = "journalist_checked"
    JOURNALIST_CHANGED = "journalist_changed"
    SOURCE_SPENT = "source_spent"
    MEDIA_MOGUL_ELECTION_STARTED = "media_mogul_election_started"
    MEDIA_MOGUL_VOTE_CAST = "media_mogul_vote_cast"
    MEDIA_MOGUL_CHANGED = "media_mogul_changed"
    DRAFT_CONTRIBUTED = "draft_contributed"
    DRAFT_PASSED = "draft_passed"
    JOURNALIST_POOL_CREATED = "journalist_pool_created"
    CARD_MOVED_TO_TOP_OF_DECK = "card_moved_to_top_of_deck"
    DISCUSSION_HELD = "discussion_held"
    URN_CARD_SUBMITTED = "urn_card_submitted"
    URN_SHUFFLED = "urn_shuffled"
    WORLD_HISTORY_REVEALED = "world_history_revealed"
    WORLD_HISTORY_POWER_CALCULATED = "world_history_power_calculated"
    COMBAT_RESOLVED = "combat_resolved"
    RESEARCH_ASSIGNMENTS_CHECKED = "research_assignments_checked"
    RESEARCH_ORDER_COMPLETED = "research_order_completed"
    RESEARCH_ORDER_DISCARDED = "research_order_discarded"
